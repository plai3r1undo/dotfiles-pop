...
/* key definitions */
#define MODKEY Mod4Mask  //window key instead of alt
...
static const Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_s,      spawn,          SHCMD("scrot -e 'mv $n ~/Pictures/Screenshots/'")},
  { MODKEY|ShiftMask,             XK_w,      spawn,          SHCMD("rofi -show window")},
	...
	{ MODKEY,                       XK_n,      setlayout,      {.v = &layouts[0]} },  /* IDK but was t */
